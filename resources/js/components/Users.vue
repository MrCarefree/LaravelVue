      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 v-if="!editMode" class="modal-title" id="addNewLabel">Add New</h5>
            <h5 v-else-if="editMode" class="modal-title" id="addNewLabel">Update User's Info</h5>
          ...
          <form @submit.prevent="editMode ? updateUser() : createUser">
            ...
            <div class="modal-footer">
              ...
              <button v-else-if="!editMode" type="submit" class="btn btn-primary">Create</button>
            </div>
          </form>
        </div>
      </div>
